...
--download('https://raw.githubusercontent.com/amjakh/Java1/master/Saidi.lua','Saidi.lua')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text =Description,url = "tg://user?id="..UserId}, },}}
...
if TextMsg == 'all' or TextMsg == '@all' then
Redis:set(Saidi.."lockalllll"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم تفعيل امر all ","md",true)
end
...
if TextMsg == 'all' or TextMsg == '@all' then
Redis:del(Saidi.."lockalllll"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ تم تعطيل امر all ","md",true)
end
if TextMsg == 'جمالي' then
...
LuaTele.sendText(msg_chat_id,Text,0,'md')
end
end
end
...
if text and text:match('^وضع لقب @(%S+) (.*)$') then
local UserName = {text:match('^وضع لقب @(%S+) (.*)$')}
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◐╿ هاذا الامر يخص 「 '..Controller_Num(4)..' 」* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
keyboard.inline_keyboard = {
{
{text = ban.first_name, url = 't.me/AKJA0'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𝐃𝐞𝐯: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/JAI6H"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'بوت', url = "https://t.me/LC6BOT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
data = {
{
{text = '◐╿العاب التسليه', data = msg.sender.user_id..'/helma1'}, {text = '◐╿الاضافات', data = msg.sender.user_id..'/helma2'}, 
},
{
...
local user = text:match("^صوره @(.*)$")
if Redis:get(Saidi.."Status:kool"..msg.chat_id) then
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&photo=https://devdeiveddev.ml/api/tele/photo.php?YYYBD='..user..'&reply_to_message_id='..msg_id)
end
end
