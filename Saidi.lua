...
Redis:del(Saidi.."Saidi:Text:Sudo:Bot"..text..msg_chat_id)   
Redis:del(Saidi.."Saidi:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Saidi.."Saidi:List:Rd:Sudo"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⦁ تم حذف الرد من قائمه الردود العامه","md",true)  
return false
end
end
...
if Redis:sismember(Saidi.."Saidi:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"🧞‍♂ تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."Saidi:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if text == ('الغاء الطرد') and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*🧞‍♂ هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
keyboard.inline_keyboard = {
{
{text = '𓄼• ٰٖ𝗠ٰٖ𝗬ٰ ٰ𝗗ٰٖ𝗘ٰٖ𝗩ٰٖ •𓄹', url = "https://t.me/MY_DEV"},
},
{
{text = '𓄼• ٰٖ𝗠ٰٖ𝗬ٰ ٰ𝗖ٰٖ𝗛ٰٖ𝗔ٰٖ𝗡ٰٖ𝗡ٰٖ𝗘ٰٖ𝗟ٰٖ •𓄹', url = "https://t.me/MYCH_ANNEL"},
},
{
